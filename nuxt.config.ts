...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      FAQ_LINK: '',                               // Link to External FAQ / '' internal when enable
      ...
      CUSTOM_MENU_ITEMS: [],                      // Custom menu to extend the frontend with additional link w/o having to modify the code. Format: [{ label: 'custom_menu.my-first-name', icon: 'i-lucide-link', to: '/custom/mypage', target: '_blank' }]
