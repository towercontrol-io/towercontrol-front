import type { GroupsHierarchySimplified, GroupCreationBody } from '~/types';
...
export default defineNuxtPlugin(() => {
  ...
  // Set the routes
  const userModuleGroupsCreationPost: string = '/groups/1.0/creation';
