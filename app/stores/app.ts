...
export const applicationStore = defineStore('app', {
  ...
  actions: {
    ...
    setFilesAdmin(isAdmin: boolean) {
      this.filesAdmin = isAdmin;
    },
    isFilesAdmin(): boolean | null {
      return this.filesAdmin;
    },    
    ...
    setAlertTemplate(isAlertTemplate: boolean) {
      this.alertTemplate = isAlertTemplate;
    },
